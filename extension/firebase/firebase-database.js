import { getApp, _getProvider, _registerComponent, registerVersion, SDK_VERSION as SDK_VERSION$1 } from './firebase-app.js';
...
class Database {
    ...
    constructor(_repoInternal,
        /** The {@link https://www.gstatic.com/firebasejs/9.6.4/firebase-app.js#FirebaseApp} associated with this Realtime Database instance. */
        app) {
 ...
 * with the provided {@link https://www.gstatic.com/firebasejs/9.6.4/firebase-app.js#FirebaseApp}. Initializes a new instance with
 * with default settings if no instance exists or if the existing instance uses
 * a custom database URL.
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.6.4/firebase-app.js#FirebaseApp} instance that the returned Realtime
